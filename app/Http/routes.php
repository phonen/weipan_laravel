...
Route::group(['middleware' => 'web'], function () {
  ...
  Route::get('/account/wxgzh/{price}', 'ApplicationController@wxgzh'); //微信支付
...
Route::group(['middleware' => ['web', 'admin.login']], function () {
  ...
  Route::any('/account/agentsj', 'ApplicationController@agentsj');
...
Route::any('/administrator/agentsjok', 'AdministratorController@agentsjok'); //拒绝审核
Route::any('/administrator/agentsjrf', 'AdministratorController@agentsjrf'); //拒绝审核
Route::any('/administrator/agentsjno', 'AdministratorController@agentsjno'); //删除审核
...
Route::get('/administrator/signa', 'AdministratorController@signa');
...
Route::any('/administrator/agentsj', 'AdministratorController@agentsj');
Route::get('/administrator/records', 'AdministratorController@records');
Route::any('/administrator/zytongdao', 'AdministratorController@zytongdao');
Route::any('/administrator/orderkillwin', 'AdministratorController@orderkillwin');
Route::any('/administrator/orderkilllose', 'AdministratorController@orderkilllose');
...
Route::any('/administrator/agentfee','AdministratorController@agentfee');

Route::get('/agent', 'AgentController@home')->name('agent.index');
...
Route::any('/callbacks/xinpay', 'CallbackController@Xinpay');
