                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/administrator/users?id_user=<?php echo $item->id_user; ?>"><?php echo $item->user->body_phone; ?></a></td>
                                    ...
                                    <td>
                                     <?php 
                                    	if ($item->striked_at == '0000-00-00 00:00:00'){ ?>
                                    		<a href="/administrator/orderkillwin?id=<?php echo $item->id ?>">强赢</a>  <a href="/administrator/orderkilllose?id=<?php echo $item->id ?>">强输</a>
                                    	<?php } else {
                                    		echo '订单已结算';
                                    		} ?></td>
                                </tr>
                            ...
                            <tr>
                                    <td colspan="13" style="text-align: center;">
                                        注意: 订单调控 强制盈利 强制亏损 这三个任一功能为打开状态时，单杀功能失效。只有在全局调控没有打开时，才可以单杀。
                                    </td>
                                </tr>
                            <tfoot>
                                <tr>
