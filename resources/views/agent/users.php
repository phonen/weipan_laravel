                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/agent/orders?id_user=<?php echo $item->id_wechat; ?>">订单记录</a> | <a href="/agent/records?id_user=<?php echo $item->id_wechat; ?>">资金记录</a> | <a href="/agent/payRequests?id_user=<?php echo $item->id_wechat; ?>">充值记录</a> | <a href="/agent/users?id_introducer=<?php echo $item->id_wechat; ?>">名下用户</a> 
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
